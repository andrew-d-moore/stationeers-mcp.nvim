...
function M._register_keymaps()
	...
	map(km.connect, "<cmd>McpConnect<cr>", "MCP: connect to server")
	map(km.chip_select, "<cmd>McpChipSelect<cr>", "MCP: select chip")
...
M.push_buffer = function()
	get_ops().push_buffer()
end
M.pull_chip = function()
	get_ops().pull_chip()
end
M.patch_chip = function()
	get_ops().patch_chip()
end
M.chip_select = function()
	get_ops().chip_select()
end
M.chip_errors = function()
	get_ops().chip_errors()
end
M.chip_logs = function()
	get_ops().chip_logs()
end
M.game_state = function()
	get_ops().game_state()
end
M.search_docs = function(q)
	get_ops().search_docs(q)
end
